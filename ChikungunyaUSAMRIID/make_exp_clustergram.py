...
def tf_clust(tf_name):
	...
	gs_list = json_scripts.load_to_dict('cstgram/gene_classes_harmonogram.json')

	# load ccle data with zscore normalization
	ccle = json_scripts.load_to_dict('cstgram/CCLE/nsclc_allzc.json')
	...
	tf_union = json_scripts.load_to_dict('cstgram/enz_and_tf_lists_gmts/TF/tf_union.json')
...
def make_expression_clustergrams():
	...
	gc = json_scripts.load_to_dict('cstgram/gene_classes_harmonogram.json')
